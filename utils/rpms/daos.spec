...
# os detection
# see if we still need this as it causes an rpmlint error:
## prefer over libpsm2-compat
#   daos-client-tests.x86_64: E: explicit-lib-dependency libpsm_infinipath1
...
%changelog
* Tue Sep 13 2022 Brian J. Murrell <brian.murrell@intel.com> 2.3.100-23
